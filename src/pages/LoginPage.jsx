      ...
      <main className="min-h-screen flex flex-col md:flex-row">
        ...
        <section className="w-full md:w-1/2 flex items-center justify-center bg-[#fdf5f4] px-6 py-16">
          <div className="w-full max-w-md">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.email || errors.credentials) setErrors((prev) => ({ ...prev, email: undefined, credentials: undefined }))
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.password || errors.credentials) setErrors((prev) => ({ ...prev, password: undefined, credentials: undefined }))
                  }}
            ...
            <div className="mt-8 rounded-xl border border-dashed border-gray-300 bg-white px-4 py-4 text-sm text-gray-500 text-center" style={{ fontFamily: 'Nunito, sans-serif' }}>
